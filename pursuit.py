...
waypoints = [(0, 0, 0), (1.1, 0, 0.1), (1.1, 0.33, 0.1),(0.95,0.33,0.1),(0.8,0.33,0.1),(0.7,0.33,0.1),(0.55,0.33,0.1),(0.4,0.33,0.1),(0.2,0.33,0.1),(0.1,0.33,0.1),
             (0, 0.33, 0.1), (0, 0, 0.1), (0, 0, 0)]
L = 0.05
map = init_map()
trace = [(0, 0, 0, 0)]
